 ...
 * Thus, adding such method will simply break the collection framework implementations. Java 8 introduces default method so that 
 * List/Collection interface can have a default implementation of forEach method, 
 * and the class implementing these interfaces need not implement the same.
 */
public class F_DefaultMethods {
